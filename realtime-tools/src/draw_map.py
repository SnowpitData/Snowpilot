...
if __name__ == '__main__':
    ...
    parser.add_argument('-p', '--params', default='{"start_date":"2021-03-01","end_date":"2021-07-10","state":"MT","text_param":"","dot_color_param":"HS","line_color_param":"","observer_group":"All","show_avs":"Daily count mean"}')
