...
(function($) {
  ...
  SnowProfile.Features = function(layerArg) {
    // TODO:  add moisture and density to features 
  ...
  '1UVx0/hpAAAAAElFTkSuQmCC';
    ...
    /*function setCommentDescr(comment) {
      ...
      var testLineDescr = SnowProfile.drawing.text('')
        .width(SnowProfile.Cfg.MOISTURE_WD)
        .addClass("snow_profile_comment_descr")
        .build(false);
      commentDescr.text("");
      ...
      if (comment !== "") {
        ...
        words.forEach(function(word, i) {
          if (word.length !== 0) {
            ...
            if (testLineDescr.bbox().width >= SnowProfile.Cfg.MOISTURE_WD) {
    ...
    this.describe = function(data) {
      ...
      if (data === undefined) {
        ...
        // TODO:  Debug bounding boxes, they are returning null when initializing 
        //    which causes the funky layout issues for pits in progress
